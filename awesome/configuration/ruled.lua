...
ruled.client.connect_signal("request::rules", function()
    ...
    ruled.client.append_rule({
        id = "titlebars",
        rule_any = {class = {"Spotify", "Org.gnome.Nautilus", "Peek"}},
    ...
    ruled.client.append_rule({
        ...
        rule_any = {
            instance = {
                "music", "fetch", "ranger" --- Firefox devtools
            },
            class = {
                "Pavucontrol", "Engrampa", "Lxappearance",
                "Nm-connection-editor", "Densify",
                "Lightdm-gtk-greeter-settings", "qt5ct", "Timeshift-gtk",
                "GParted", "Gthumb", "telegram-desktop", "BleachBit"
            },
            name = {
                "Event Tester" -- xev
            },
